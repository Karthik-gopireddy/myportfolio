...
import { dwonloadIcon, githubIcon } from "../assets/imports";4
import karthik from "../assets/images/karthik.jpeg"
import {
    ...
    >
      <div className="text-center sm:text-left">
        <div className="xl:text-5xl lg:text-4xl text-3xl text-white font-semibold">
          <h1>Hii there👋,</h1>
          <h1 className="my-1" id="user-detail-name">I am Karthik Gopireddy</h1>
        </div>
